...
Data Preparation 2.
Generate new features: IP_count
@author: Chen-An Fan
"""
...
stime = time.time()
training_data.to_csv('CSV_T1/training_data_encoded_new_addFeature.csv',header=True,index=False)
test_data.to_csv('CSV_T1/test_data_encoded_new_addFeature.csv',header=True,index=False)
valid_data_with_labels.to_csv('CSV_T1/valid_data_with_labels_encoded_new_addFeature.csv',header=True,index=False)
