# -*- coding: utf-8 -*-
"""
Created on Mon Oct 12 03:04:34 2020
Security Analytics Project 2 - Task1 - OCSVM
@author: b0350
"""
import pandas as pd
import numpy as np
...
training_data = training_data.sample(n=200000, axis=0, replace=False, random_state = 1)

# %%Normalize
# not normalize for feature generate method 1
...
#df_valid_pred.to_csv('CSV_T1/valid_pred_addFeature_normalize.csv',header=True,index=False)
#df_valid_pred.to_csv('Useful_Model/Feature1-encoded/OCSVM/valid_predicted_Score.csv',header=True,index=False)
#df_valid_pred.to_csv('Useful_Model/Feature3-PCA/OCSVM/valid_predicted_Score.csv',header=True,index=False)
df_valid_pred.to_csv('Useful_Model/Featrue2-normalize/OCSVM/valid_predicted_Score.csv',header=True,index=False)
...
disp = plot_confusion_matrix(clf, valid_pred, valid_label,
...
cm = metrics.confusion_matrix(valid_pred,valid_label,labels=[1,-1]) #Note the label order: -1 is the positive
...
#df_test_pred.to_csv('CSV_T1/test_pred_addFeature_normalize.csv',header=True,index=False)
#df_test_pred.to_csv('Useful_Model/Feature1-encoded/OCSVM/test_pred_score.csv',header=True,index=False)
#df_test_pred.to_csv('Useful_Model/Feature3-PCA/OCSVM/test_pred_score.csv',header=True,index=False)
df_test_pred.to_csv('Useful_Model/Featrue2-normalize/OCSVM/test_pred_score.csv',header=True,index=False)
...
#result.to_csv('Useful_Model/Feature1-encoded/OCSVM/test_attack_log_feature1.csv',header=True,index=False)
#result.to_csv('Useful_Model/Feature3-PCA/OCSVM/test_attack_log_feature1.csv',header=True,index=False)
result.to_csv('Useful_Model/Featrue2-normalize/OCSVM/test_attack_log_feature1.csv',header=True,index=False)
